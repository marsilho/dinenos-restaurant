                ...
                <div class="col-lg-3 col-md-6 col-sm-6 grid-item cat3">
                    <div class="portfolio-wrapper2 mb-30">
                        ...
                        <div class="portfolio-content">
                            ...
                            <div class="content">
                                <p class="title"><a href="shop-details.html">Wild Mushroom Arancini</a></p>
                                <span class="price">$33.00</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 grid-item cat1">
                    <div class="portfolio-wrapper2 mb-30">
                        ...
                        <div class="portfolio-content">
                            ...
                            <div class="content">
                                <p class="title"><a href="shop-details.html">Fresh Oysters Dozen</a></p>
                                <span class="price">$30.00</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 grid-item cat2 cat3">
                    <div class="portfolio-wrapper2 mb-30">
                        ...
                        <div class="portfolio-content">
                            ...
                            <div class="content">
                                <p class="title"><a href="shop-details.html">Bruno’s Scribble</a></p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 grid-item cat1">
                    <div class="portfolio-wrapper2 mb-30">
                        ...
                        <div class="portfolio-content">
                            ...
                            <div class="content">
                                <p class="title"><a href="shop-details.html">Purple Corn Tostada</a></p>
